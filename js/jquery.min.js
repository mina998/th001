...
$(function(){
	$("nav ul li").hover(function(){
	    $(this).find(".nav_dus").stop().slideDown();
	},function(){
	    $(this).find(".nav_dus").stop().slideUp();
	});
	$("nav ul li").hover(function(){
	    $(this).find(".nav_pro").stop().slideDown();
	},function(){
	    $(this).find(".nav_pro").stop().slideUp();
	});
	$("#inq_btn").click(function(){
		$("html,body").animate({scrollTop: $("#index_5").offset().top-200}, 1000);
	})
	$(".na_ple a").mouseover(function(){
		$(this).addClass("cur").siblings().removeClass("cur");
		$(".na_pri dl").eq($(this).index()).addClass("cur").siblings().removeClass("cur");
	})
	$(".indus_ul li").mouseover(function(){
...
$(function(){
     $(document).on("click", ".search-button i", function (e) {
        e.stopPropagation();
    ...
    $(".fo_h4").click(function(){
    	$(this).parent().find(".fo_opul").slideToggle();
    })
...
$(function(){
	...
	$(".faqlist h3").click(function(){
		$(this).addClass("active").next().addClass("active").slideDown().parent().siblings().children(".faqlist .fa_nrp").removeClass("active").slideUp().prev().removeClass("active");
		return false;
	});
})
...
$(function(){
	$('.abwybox .awit').mouseover(function(){
	    $(this).addClass('on').siblings().removeClass('on');
	});
})
